...
class APGDT(Attack):
    ...
    def forward(self, images, t, labels):
        ...
        _, adv_images = self.perturb(images, t, labels, cheap=True)
    ...
    def attack_single_run(self, x_in, timestep, y_in):
        ...
        for _ in range(self.eot_iter):
            with torch.enable_grad():
                ...
                logits = self.get_logits(x_adv, timestep)
    ...
    def perturb(self, x_in, timestep, y_in, best_loss=False, cheap=True):
