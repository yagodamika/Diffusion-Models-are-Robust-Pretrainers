...
class Attack(object):
    ...
    def forward(self, inputs, t, labels=None, *args, **kwargs):
        r"""
    ...
    def get_logits(self, inputs, t, labels=None, *args, **kwargs):
        if self._normalization_applied is False:
            inputs = self.normalize(inputs)
        logits = self.model(inputs, t)
        return logits
    ...
    def __call__(self, inputs, t, labels=None, *args, **kwargs):
        given_training = self.model.training
        ...
        if self._normalization_applied is True:
            ...
            adv_inputs = self.forward(inputs, t, labels, *args, **kwargs)
